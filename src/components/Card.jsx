...
function Card() {
  ...
  return (
    <div className="grid grid-cols-5 gap-4 p-12 md:grid-cols-3 ssm:grid-cols-2 ssm:p-4">
      {items.map((item) => (
        <div className="hover:-translate-y-6 hover:scale-105 hover:ease-in hover:duration-300 dark:text-white dark:bg-black/30 bg-white rounded-lg shadow-lg overflow-hidden w-full border border-pizazz/40  p-4 h-96 ssm:h-80 hover:shadow-xl hover:border-dark-tangerine hover:border-2">
